...
[Naikaku](https://github.com/naikaku1) 氏によってChrome向けに開発された [YTM_Immersion](https://github.com/naikaku1/YTM-Immersion) を [hacshew](https://github.com/hacshew) が独自にFirefox向けに改変しています。本家の改変には追従していません (v0.1.0~)。
